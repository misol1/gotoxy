...
gcc %WARN% -s -o cmdwiz.exe cmdwizU.c -Os rc\cmdwiz.o -luser32 -lwinmm -lgdi32
@if exist cmdwiz.exe strip cmdwiz.exe
@echo.
gcc -s -o cmdwiz-ascii.exe cmdwiz.c -O2 rc\cmdwiz-ascii.o -luser32 -lwinmm -lgdi32
@echo.
gcc %WARN% -s -o gotoxy.exe -O2 rc\gotoxy.o gotoxy.c
@echo.
gcc %WARN% -s -DSUPPORT_EXTENDED -O2 rc\gotoxy-extended.o -lshell32 -lwinmm -luser32 -o gotoxy_extended.exe gotoxy.c
@set WARN=
@echo.
