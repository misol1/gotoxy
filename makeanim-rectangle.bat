...
:MAKELINE
set /a TMP=%NOFLINES%/2-%EXPCNT%
if %1 lss %TMP% set SCR1="!SCR1:~1,-1!!EMPTY:~1,-1!\n"&goto :eof
if %1 == %TMP% set SCR1="!SCR1:~1,-1!!TOPB:~1,-1!\n"&goto :eof
set /a TMP=%NOFLINES%/2+%EXPCNT%
if %1 gtr %TMP% set SCR1="!SCR1:~1,-1!!EMPTY:~1,-1!\n"&goto :eof
if %1 == %TMP% set SCR1="!SCR1:~1,-1!!TOPB:~1,-1!\n"&goto :eof
...
set SIDES="%COL%"
set /a TMP=80/2-%EXPCNT%+%1*0-0
for /L %%a in (1,1,%TMP%) do set SIDES="!SIDES:~1,-1! "
set SIDES="!SIDES:~1,-1!:#"
...
set TOPB="%COL%"
for /L %%a in (1,1,%TMP%) do set TOPB="!TOPB:~1,-1! "
set TOPB="!TOPB:~1,-1! "
set /a TMP2+=2
